...
public class MessageAdapterProvider extends RecyclerView.Adapter<MessageAdapterProvider.MyViewHolder> {
    ...
    public MessageAdapterProvider(ChatRoom chatRoom, List<Chats> chatslist, String receiverId)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        if (viewType == MESSAGE_RIGHT)
        {
            ...
            View view = LayoutInflater.from(chatRoom).inflate(R.layout.chat_item_right, parent, false);
        ...
        {
            View view = LayoutInflater.from(chatRoom).inflate(R.layout.chat_item_left, parent, false);
            return new MyViewHolder(view);
        }
