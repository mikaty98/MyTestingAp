...
public class ProviderMessageAdapter extends RecyclerView.Adapter<ProviderMessageAdapter.MyViewHolder> {
    ...
    public ProviderMessageAdapter(ProviderChatRoomFragment providerChatRoomFragment, List<Chats> chatslist, String receiverId)
    {
        this.providerChatRoomFragment = providerChatRoomFragment;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        if (viewType == MESSAGE_RIGHT)
        {
            ...
            View view = LayoutInflater.from(providerChatRoomFragment.getContext()).inflate(R.layout.chat_item_right, parent, false);
        ...
        {
            View view = LayoutInflater.from(providerChatRoomFragment.getContext()).inflate(R.layout.chat_item_left, parent, false);
            return new MyViewHolder(view);
        }
